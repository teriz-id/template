...
@section('judul', 'Verifikasi Akun Kamu')
@section('content')
...
<div class="py-10 pb-10">
    ...
    <form class="form w-100 mb-10" novalidate="novalidate" id="formVerifikasi" action="{{ baseurl }}/user/register/validasiwhatsapp" method="POST">
        <div class="text-center mb-10">
            <img alt="Logo" class="theme-light-show mh-125px" src="{{ baseurl }}/static/auth/svg/smartphone-2.svg" />
            <img alt="Logo" class="theme-dark-show mh-125px" src="{{ baseurl }}/static/auth/svg/smartphone-2-dark.svg" />
        </div>
        <div class="text-center mb-10">
            ...
            <div class="fw-bold text-dark fs-3">
                <span class="ubahsini">+{{ substr($verify['hp'], 0, 5) . '-' . substr($verify['hp'], 5, 4) . '-' . substr($verify['hp'], 9); }}</span>
        ...
        <input type="hidden" name="auth_key" value="{{ $verify['auth_key'] }}">
        ...
        function startTimer() {
            countdown = setInterval(function() {
                ...
                if (time_left < 0) {
                    ...
                    $('#countdown').html('<a href="javascript:void();" class="link-primary fw-bold fs-5 resendOTP" data-key="{{ $verify["auth_key"] }}">{{ Lang::bhs("Kirim Ulang") }}</a>');
                } else {
