...
<head>
    <title><?= Lang::bhs('Masuk ke Qondangan') ?></title>
    <meta charset="utf-8" />
...
<body id="kt_body" class="app-blank app-blank">
                        ...
                        <form class="form w-100" id="formLogin" action="<?= baseurl ?>/user/login/auth" method="POST">
                            <div class="card-body">
                                <div class="text-start mb-10">
                                    <h1 class="text-dark fw-bolder mb-3 fs-2x"><?= Lang::bhs('Masuk ke Qondangan') ?></h1>
                                    <div class="text-gray-400 fw-semibold fs-6"><?= Lang::bhs('Gunakan Email atau Sosial media untuk masuk ke Qondangan.') ?></div>
                                </div>
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="<?= baseurl ?>/user/login/google" class="symbol symbol-circle symbol-45px w-45px bg-light me-3">
                                            <img alt="Login With Google" src="<?= baseurl ?>/static/admin/media/svg/brand-logos/google-icon.svg" class="p-4" />
                                        </a>
                                        <a href="Javascript:void();" class="symbol symbol-circle symbol-45px w-45px bg-light me-3 commingsooon">
                                            <img alt="Login With Facebook" src="<?= baseurl ?>/static/admin/media/svg/brand-logos/facebook-3.svg" class="p-4" />
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="<?= baseurl ?>/static/admin/js/custom/authentication/sign-in/general.js"></script>
    <script>
        // $(document).on('click', '.commingsooon', function(){});
